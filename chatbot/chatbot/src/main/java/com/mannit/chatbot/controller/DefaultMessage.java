...
public class DefaultMessage {
    ...
    @Autowired
    public DefaultMessage(RestTemplate restTemplate, Configvalues values,Currentpatientsrepo app,MessagestatusRepo repo) {
...
//            System.out.println(responseBody);
    ...
    private Map<String, Object> createApiRequestBody() {
        ...
        requestBody.put("template_name", "betatst");
